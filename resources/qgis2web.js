...
map.getView().fit([11037325.172542, -119675.807917, 13331675.922074, 1041051.035171], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NUMBER OF DOMESTIC TOURISTS 2022 AND HIKING PLACES</h2>';
        return titleElement;
    })(),
